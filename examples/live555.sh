...
export AFLGO=$HOME/fuzzingtool/snap-aflgo/builds/aflgo
...
$AFLGO/distance/gen_distance_fast.py $SUBJECT/testProgs/ $TMP_DIR  

./genMakefiles linux2
make -j clean all

# changing for your environment
export SNAPFUZZ=$HOME/fuzzingtool/snap-aflgo
